      ...
      exercises: [
        ...
        },
        {
          name: {
            ...
            tr: 'Dumbbell Shoulder Press',
            de: 'Schulterdrücken mit Kurzhanteln'
          },
          sets: 3,
          reps: '10-12',
          description: {
        ...
        {
          name: {
            en: 'Cable Biceps Curl',
            tr: 'Cable Biceps Curl',
            de: 'Bizeps-Curls am Kabelzug'
          },
          sets: 3,
          reps: '12-15',
          description: {
      ...
      exercises: [
        {
          name: {
            ...
            tr: 'Kettlebell Goblet Squat',
            de: 'Kettlebell-Goblet-Kniebeugen'
          },
          sets: 3,
          reps: '12',
          description: {
        ...
        },
        {
          name: {
            en: 'Dumbbell Row',
            tr: 'Dumbbell Row',
            de: 'Einarmiges Rudern mit Kurzhantel'
          },
          sets: 3,
          reps: '10',
          description: {
